...
db_engine: Engine = create_engine('postgresql+psycopg2://dev:' + config['db_password'] + '\@localhost:5432/efemerDB')
conn = psycopg2.connect("host=localhost dbname=efemerDB user=dev password=" + config['db_password'] + " port=5432")
